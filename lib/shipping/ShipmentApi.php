...
class ShipmentApi
{
     ...
     * @param  \pitneybowesShipping\shippingApi.model\Carrier $carrier Conditional. The carrier. This is required if the carrier is not USPS (optional)
     *
     * @throws \pitneybowesShipping\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \pitneybowesShipping\shippingApi.model\CancelShipment|\pitneybowesShipping\shippingApi.model\Errors
     */
     ...
     * @throws \pitneybowesShipping\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \pitneybowesShipping\shippingApi.model\CancelShipment|\pitneybowesShipping\shippingApi.model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelShipmentWithHttpInfo($x_pb_transaction_id, $shipment_id, $x_pb_unified_error_structure = 'true', $x_pb_shipper_carrier_account_id = null, $cancel_initiator = null, $carrier = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\pitneybowesShipping\shippingApi.model\CancelShipment' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\pitneybowesShipping\shippingApi.model\CancelShipment', []),
            ...
            $returnType = '\pitneybowesShipping\shippingApi.model\CancelShipment';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\pitneybowesShipping\shippingApi.model\CancelShipment',
     ...
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     * @param  \pitneybowesShipping\shippingApi.model\Shipment $shipment request (required)
     ...
     * @param  bool $x_pb_unified_error_structure Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. (optional, default to true)
     * @param  \pitneybowesShipping\shippingApi.model\Carrier $carrier carrier (optional)
     *
     * @throws \pitneybowesShipping\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \pitneybowesShipping\shippingApi.model\Shipment|\pitneybowesShipping\shippingApi.model\Errors
     ...
     * @param  string $shipment_id Required. The shipment ID that was issued when shipment label was generated. (required)
     * @param  bool $x_pb_unified_error_structure Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. (optional, default to true)
     * @param  \pitneybowesShipping\shippingApi.model\Carrier $carrier (optional)
     *
     * @throws \pitneybowesShipping\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \pitneybowesShipping\shippingApi.model\Shipment|\pitneybowesShipping\shippingApi.model\Errors, HTTP status code, HTTP response headers (array of strings)
