...
class ContainerApi
{
     ...
     * @return \pitneybowesShipping\shippingApi.model\ContainerManifestResponse
     */
     ...
     * @throws \pitneybowesShipping\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \pitneybowesShipping\shippingApi.model\ContainerManifestResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getContainerizedParcelsLabelsWithHttpInfo($x_pb_transaction_id, $manifest, $x_pb_unified_error_structure = true)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\pitneybowesShipping\shippingApi.model\ContainerManifestResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\pitneybowesShipping\shippingApi.model\ContainerManifestResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\pitneybowesShipping\shippingApi.model\ContainerManifestResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\pitneybowesShipping\shippingApi.model\ContainerManifestResponse',
