...
class ParcelProtectionApi
{
     ...
     * @param  \pitneybowesShipping\shippingApi.model\VoidParcelProtectionRequest $void_parcel_protection_request manifest (required)
     ...
     * @return \pitneybowesShipping\shippingApi.model\VoidParcelProtectionResponse|\pitneybowesShipping\shippingApi.model\Errors
     */
     ...
     * @throws \pitneybowesShipping\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \pitneybowesShipping\shippingApi.model\VoidParcelProtectionResponse|\pitneybowesShipping\shippingApi.model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelParcelProtectionWithHttpInfo($x_pb_transaction_id, $parcel_protection_reference_id, $void_parcel_protection_request, $x_pb_unified_error_structure = true)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\pitneybowesShipping\shippingApi.model\VoidParcelProtectionResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\pitneybowesShipping\shippingApi.model\VoidParcelProtectionResponse', []),
            ...
            $returnType = '\pitneybowesShipping\shippingApi.model\VoidParcelProtectionResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\pitneybowesShipping\shippingApi.model\VoidParcelProtectionResponse',
     ...
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     * @param  \pitneybowesShipping\shippingApi.model\ParcelProtectionCreateRequest $parcel_protection_create_request manifest (required)
     * @param  bool $x_pb_unified_error_structure Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. (optional, default to true)
     *
     * @throws \pitneybowesShipping\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \pitneybowesShipping\shippingApi.model\ParcelProtectionCreateResponse|\pitneybowesShipping\shippingApi.model\Errors
     */
     ...
     * @throws \pitneybowesShipping\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \pitneybowesShipping\shippingApi.model\ParcelProtectionCreateResponse|\pitneybowesShipping\shippingApi.model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function getParcelProtectionCoverageWithHttpInfo($x_pb_transaction_id, $parcel_protection_create_request, $x_pb_unified_error_structure = true)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\pitneybowesShipping\shippingApi.model\ParcelProtectionCreateResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\pitneybowesShipping\shippingApi.model\ParcelProtectionCreateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\pitneybowesShipping\shippingApi.model\ParcelProtectionCreateResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\pitneybowesShipping\shippingApi.model\ParcelProtectionCreateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $x_pb_transaction_id Required. A unique identifier for the transaction, up to 25 characters. (required)
     * @param  \pitneybowesShipping\shippingApi.model\ParcelProtectionQuoteRequest $parcel_protection_quote_request manifest (required)
     * @param  bool $x_pb_unified_error_structure Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. (optional, default to true)
     *
     * @throws \pitneybowesShipping\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \pitneybowesShipping\shippingApi.model\ParcelProtectionQuoteResponse|\pitneybowesShipping\shippingApi.model\Errors
     */
     ...
     * @throws \pitneybowesShipping\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \pitneybowesShipping\shippingApi.model\ParcelProtectionQuoteResponse|\pitneybowesShipping\shippingApi.model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function getParcelProtectionQuoteWithHttpInfo($x_pb_transaction_id, $parcel_protection_quote_request, $x_pb_unified_error_structure = true)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\pitneybowesShipping\shippingApi.model\ParcelProtectionQuoteResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\pitneybowesShipping\shippingApi.model\ParcelProtectionQuoteResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\pitneybowesShipping\shippingApi.model\ParcelProtectionQuoteResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\pitneybowesShipping\shippingApi.model\ParcelProtectionQuoteResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \pitneybowesShipping\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \pitneybowesShipping\shippingApi.model\ParcelProtectionPolicyResponse|\pitneybowesShipping\shippingApi.model\Errors
     */
     ...
     * @throws \pitneybowesShipping\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \pitneybowesShipping\shippingApi.model\ParcelProtectionPolicyResponse|\pitneybowesShipping\shippingApi.model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
