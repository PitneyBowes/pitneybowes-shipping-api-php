...
class CarrierInfoApi
{
     ...
     *
     * @param  \OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CarrierFacilityRequest $carrier_facility_request carrier_facility_request (required)
     ...
     * @return \OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CarrierFacilityResponse|\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CrossBorderQuotesErrors
     */
     ...
     * Find Carrier Facilities
     *
     * @param  \OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CarrierFacilityRequest $carrier_facility_request (required)
     * @param  bool $x_pb_unified_error_structure Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. (optional, default to true)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CarrierFacilityResponse|\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CrossBorderQuotesErrors, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCarrierFacilitiesWithHttpInfo($carrier_facility_request, $x_pb_unified_error_structure = true)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CarrierFacilityResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CarrierFacilityResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
                    if ('\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CrossBorderQuotesErrors' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CrossBorderQuotesErrors', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CarrierFacilityResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CarrierFacilityResponse',
                ...
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CrossBorderQuotesErrors',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\ISOCountryCode $origin_country_code The two-character ISO country code for the country where the shipment originates. (required)
     * @param  bool $x_pb_unified_error_structure Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. (optional, default to true)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\InlineResponse200|\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\Errors
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\InlineResponse200|\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCarrierLicenseAgreementWithHttpInfo($carrier, $origin_country_code, $x_pb_unified_error_structure = true)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\InlineResponse200' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\InlineResponse200', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\InlineResponse200';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\InlineResponse200',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\Carrier $carrier The carrier name. **Currently this must be set to: USPS** (required)
     * @param  \OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\ISOCountryCode $origin_country_code The [two-character ISO country code](https://www.iso.org/obp/ui/#search) for the country where the shipment originates. (required)
     * @param  \OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\ISOCountryCode $destination_country_code The [two-character ISO country code](https://www.iso.org/obp/ui/#search) for the country of the shipment&#39;s destination address. (required)
     * @param  bool $x_pb_unified_error_structure Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. (optional, default to true)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CarrierRule|\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\Errors
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CarrierRule|\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCarrierServiceRulesWithHttpInfo($carrier, $origin_country_code, $destination_country_code, $x_pb_unified_error_structure = true, $rate_type_id = null, $future_shipment_date = null, $return_shipment = null, $compact_response = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CarrierRule' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CarrierRule', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CarrierRule';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\CarrierRule',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object[]|\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\Errors
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object[]|\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
