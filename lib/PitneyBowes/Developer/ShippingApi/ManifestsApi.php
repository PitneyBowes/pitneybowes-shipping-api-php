...
class ManifestsApi
{
     ...
     * @return \OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\Manifest|\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\Errors
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\Manifest|\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\Errors, HTTP status code, HTTP response headers (array of strings)
     */
    public function createManifestWithHttpInfo($x_pb_transaction_id, $manifest, $x_pb_unified_error_structure = true)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\Manifest' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\Manifest', []),
            ...
            $returnType = '\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\Manifest';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\PitneyBowes.Developer.ShippingApi.Model\Manifest',
