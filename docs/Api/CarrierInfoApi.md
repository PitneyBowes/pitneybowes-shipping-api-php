# pitneybowesShipping\CarrierInfoApi
...
> \pitneybowesShipping\shippingApi.model\CarrierFacilityResponse getCarrierFacilities($carrier_facility_request, $x_pb_unified_error_structure)
...
------------- | ------------- | ------------- | -------------
 **carrier_facility_request** | [**\pitneybowesShipping\shippingApi.model\CarrierFacilityRequest**](../Model/CarrierFacilityRequest.md)|  |
 **x_pb_unified_error_structure** | **bool**| Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. | [optional] [default to true]

### Return type

[**\pitneybowesShipping\shippingApi.model\CarrierFacilityResponse**](../Model/CarrierFacilityResponse.md)
...
> \pitneybowesShipping\shippingApi.model\InlineResponse200 getCarrierLicenseAgreement($carrier, $origin_country_code, $x_pb_unified_error_structure)
...
$origin_country_code = US; // \pitneybowesShipping\shippingApi.model\ISOCountryCode | The two-character ISO country code for the country where the shipment originates.
$x_pb_unified_error_structure = true; // bool | Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs.
 ...
 **origin_country_code** | [**\pitneybowesShipping\shippingApi.model\ISOCountryCode**](../Model/.md)| The two-character ISO country code for the country where the shipment originates. |
 **x_pb_unified_error_structure** | **bool**| Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. | [optional] [default to true]

### Return type

[**\pitneybowesShipping\shippingApi.model\InlineResponse200**](../Model/InlineResponse200.md)
...
> \pitneybowesShipping\shippingApi.model\CarrierRule getCarrierServiceRules($carrier, $origin_country_code, $destination_country_code, $x_pb_unified_error_structure, $rate_type_id, $future_shipment_date, $return_shipment, $compact_response)
...
$carrier = USPS; // \pitneybowesShipping\shippingApi.model\Carrier | The carrier name. **Currently this must be set to: USPS**
$origin_country_code = US; // \pitneybowesShipping\shippingApi.model\ISOCountryCode | The [two-character ISO country code](https://www.iso.org/obp/ui/#search) for the country where the shipment originates.
$destination_country_code = IN; // \pitneybowesShipping\shippingApi.model\ISOCountryCode | The [two-character ISO country code](https://www.iso.org/obp/ui/#search) for the country of the shipment's destination address.
$x_pb_unified_error_structure = true; // bool | Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **carrier** | [**\pitneybowesShipping\shippingApi.model\Carrier**](../Model/.md)| The carrier name. **Currently this must be set to: USPS** |
 **origin_country_code** | [**\pitneybowesShipping\shippingApi.model\ISOCountryCode**](../Model/.md)| The [two-character ISO country code](https://www.iso.org/obp/ui/#search) for the country where the shipment originates. |
 **destination_country_code** | [**\pitneybowesShipping\shippingApi.model\ISOCountryCode**](../Model/.md)| The [two-character ISO country code](https://www.iso.org/obp/ui/#search) for the country of the shipment&#39;s destination address. |
 **x_pb_unified_error_structure** | **bool**| Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. | [optional] [default to true]
...
[**\pitneybowesShipping\shippingApi.model\CarrierRule**](../Model/CarrierRule.md)
