# pitneybowesShipping\ShipmentApi
...
> \pitneybowesShipping\shippingApi.model\CancelShipment cancelShipment($x_pb_transaction_id, $shipment_id, $x_pb_unified_error_structure, $x_pb_shipper_carrier_account_id, $cancel_initiator, $carrier)
...
$apiInstance = new pitneybowesShipping\Api\ShipmentApi(
...
$carrier = USPS; // \pitneybowesShipping\shippingApi.model\Carrier | Conditional. The carrier. This is required if the carrier is not USPS
 ...
 **carrier** | [**\pitneybowesShipping\shippingApi.model\Carrier**](../Model/.md)| Conditional. The carrier. This is required if the carrier is not USPS | [optional]

### Return type

[**\pitneybowesShipping\shippingApi.model\CancelShipment**](../Model/CancelShipment.md)
...
> \pitneybowesShipping\shippingApi.model\Shipment createShipmentLabel($x_pb_transaction_id, $shipment, $x_pb_unified_error_structure, $x_pb_integrator_carrier_id, $x_pb_shipper_rate_plan, $x_pb_shipment_group_id, $x_pb_shipper_carrier_account_id, $include_delivery_commitment)
...
------------- | ------------- | ------------- | -------------
 **x_pb_transaction_id** | **string**| Required. A unique identifier for the transaction, up to 25 characters. |
 **shipment** | [**\pitneybowesShipping\shippingApi.model\Shipment**](../Model/Shipment.md)| request |
...
> \pitneybowesShipping\shippingApi.model\Shipment reprintShipment($shipment_id, $x_pb_unified_error_structure, $carrier)
...
$x_pb_unified_error_structure = true; // bool | Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs.
$carrier = USPS; // \pitneybowesShipping\shippingApi.model\Carrier | 
 ...
 **x_pb_unified_error_structure** | **bool**| Set this to true to use the standard [error object](https://shipping.pitneybowes.com/reference/error-object.html#standard-error-object) if an error occurs. | [optional] [default to true]
 **carrier** | [**\pitneybowesShipping\shippingApi.model\Carrier**](../Model/.md)|  | [optional]
...
> \pitneybowesShipping\shippingApi.model\Shipment retryShipment($original_transaction_id, $x_pb_unified_error_structure, $carrier)
